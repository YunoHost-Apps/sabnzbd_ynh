...
> _This package allows you to install SabNZBD app quickly and simply on a YunoHost server.
...
![Screenshot of SabNZBD app](./doc/screenshots/example.png)
...
- Official app website: <https://sabnzbd.org>
  <!-- - Official user documentation: <https://yunohost.org/apps> -->
  <!-- - Official admin documentation: <https://yunohost.org/packaging_apps> -->
- Upstream app code repository: [<https://github.com/sabnzbd/sabnzbd>](https://github.com/sabnzbd/sabnzbd)
...
or
sudo yunohost app upgrade sabnzbd -u https://github.com/YunoHost-Apps/sabnzbd_ynh/tree/testing --debug
```
